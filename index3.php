                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" id="start_date" placeholder="Période du..." readonly>
                        </div>
                    </div>
                </div>  
                <div class="row">
                    <div class="col-md-6">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" id="end_date" placeholder="Au..." readonly>
                        </div>
                    </div>
                </div>
                <div>
